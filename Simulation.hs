...
moveParticle dt p@(Particle m c (Pos x y z) (Vel vx vy vz)) =
  p { ppos = Pos (x + dt * vx) (y + dt * vy) (z + dt * vz) }

-- | Accelerate a particle in dependence on the field for the given
-- number of (simulated) seconds.
...
-- | Update the force of sampling points
